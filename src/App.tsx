...
const Presenter:FC<AppProps> = ( props: AppProps ) => {
    ...
    return ( <>
        ...
        >{ props.btnPauseText }</Button>
        <hr />
        <label className={ css.label } htmlFor="">
            <span className={ css.labelWidth }>Ширина ячейки</span>
            <InputNumber value={ props.cellWidth } name="cellWidth" onChange={ props.changeCell } />
        </label>
        <label className={ css.label } htmlFor="">
            <span className={ css.labelWidth }>Высота ячейки</span>
            <InputNumber value={ props.cellHeight } name="cellHeight" onChange={ props.changeCell } />
        </label>
    </>
    );
}
